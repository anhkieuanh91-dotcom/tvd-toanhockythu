...
export const CURRICULUM: Grade[] = [
  ...
  },
  {
    ...
    nameEn: "Grade 2",
    topics: [
      { id: "so-hoc-2", name: "Số và Phép tính", nameEn: "Numbers and Operations", description: "Cộng trừ có nhớ, bảng nhân 2, 5. Tìm thành phần chưa biết", descriptionEn: "Addition & subtraction with regrouping, multiplication tables 2, 5. Finding unknown components" },
